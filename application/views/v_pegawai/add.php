          ...
          <div class="row">
            <div class="col-sm-12 col-md-6">
              ...
              <label for="pgw_nip" class="control-label">NIP</label>
                <input required autocomplete="off" type="text" name="pgw_nip" value="<?php echo $this->input->post('pgw_nip'); ?>" class="form-control" id="pgw_nip" />
            ...
            <div class="col-sm-12 col-md-6">
              ...
              <div class="form-group">
                <input required autocomplete="off" type="text" name="pgw_nm" value="<?php echo $this->input->post('pgw_nm'); ?>" class="form-control" id="pgw_nm" />
            ...
            <div class="col-12">
              <div class="row">
                ...
                <div class="col-6">
                  ...
                  <div class="form-group">
                    <input required autocomplete="off" type="text" name="pgw_tlp" value="<?php echo $this->input->post('pgw_tlp'); ?>" class="form-control" id="pgw_tlp" />
            ...
            <div class="col-12">
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="form-group">
                    <input required autocomplete="off" type="text" name="pgw_tlh" value="<?php echo $this->input->post('pgw_tlh'); ?>" class="form-control" id="pgw_tlh" />
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <select name="pgw_jab" class="form-control">
                      ...
                      {
                        $selected = ($display_text == $this->input->post('pgw_jab')) ? ' selected="selected"' : "";

                        echo '<option value="'.$display_text.'" '.$selected.'>'.$display_text.'</option>';
                      } 
                      ?>
                    </select>
                    <div class="text-danger"><?php echo form_error('pgw_jab');?></div>
                  </div>
                </div>  
              </div>
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input required autocomplete="off" type="text" name="pgw_eml" value="<?php echo $this->input->post('pgw_eml'); ?>" class="form-control" id="pgw_eml" />
                    <div class="text-danger"><?php echo form_error('pgw_eml');?></div>
                  </div>
                </div>
                  <div class="col-md-6">
                    <label for="pgw_snd" class="control-label">Kata sandi</label>
                    <input required  autocomplete="off" name="pgw_snd" class="form-control" id="pgw_snd" type="password" maxlength="30"  />

...
<div class="row">
  <div class="col-12">
    <div class="card">
     <?php echo form_open('pegawai/edit/'.$pegawai['pgw_id']); ?>
                  ...
                  <div class="form-group">
                   <?php if ($level=='Kepala Kantor'): ?>
                     <select name="pgw_jab" class="form-control">
                       ...
                       {
                         $selected = ($display_text == ($this->input->post('pgw_jab')?$this->input->post('pgw_jab'):$pegawai['pgw_jab'])) ? ' selected="selected"' : "";
                     ...
                     <?php else: ?>
                      <input readonly="" disabled="" autocomplete="off" type="text" name="pgw_jab" value="<?php echo ($pegawai['pgw_jab']); ?>" class="form-control" id="pgw_jab" />
                   <?php endif ?>

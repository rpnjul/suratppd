							...
							<div class="row">
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<input autocomplete="off" type="text" id="psl_no" name="psl_no" value="<?php echo ($this->input->post('psl_no')?$this->input->post('psl_no'):$srtms['psl_no']); ?>" class="form-control" />
										<span class="text-danger"><?php echo form_error('psl_no');?></span>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										<label for="#psl_nm" class="control-label"><span class="text-danger">*</span> Pemohon</label>
										<input autocomplete="off" type="text"  readonly="" id="psl_nm" name="psl_nm" class="form-control" value="<?php echo ($this->input->post('psl_nm')?$this->input->post('psl_nm'):$srtms['direktur_nm']); ?>" />
							...
							<div class="row">
								<div class="col-sm-12 col-md-6">
									<div class="form-group">
										...
										<input autocomplete="off" disabled="" type="text" id="srtms_no" name="srtms_no" value="<?php echo $srtms['srtms_no']; ?>" class="form-control" />
								...
								<div class="col-sm-12 col-md-6">
									...
									<label for="#srtms_sft" class="control-label"><span class="text-danger">*</span> Sifat Surat</label>
										<select name="srtms_sft" class="form-control">
											...
											{
												$selected = ($display_text ==($this->input->post('srtms_sft')?$this->input->post('srtms_sft'):$srtms['srtms_sft'])) ? ' selected="selected"' : "";
							...
							<div class="row">
								<div class="col-sm-12 col-md-6">
									<div class="form-group">
										...
										<input autocomplete="off" type="text" id="srtms_tgl" name="srtms_tgl" readonly="" value="<?php echo $this->loader->konversi_tanggal($srtms['srtms_tgl']); ?>" class="form-control" />
								...
								<div class="col-sm-12 col-md-6">					
									<div class="form-group">
										...
										<input autocomplete="off" disabled="" type="text" id="srtms_trm" name="srtms_trm" value="<?php echo $srtms['pgw_nip']; ?>" class="form-control" readonly />

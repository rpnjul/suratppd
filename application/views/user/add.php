          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="usr_lvl" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('usr_lvl')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="usr_eml" value="<?php echo $this->input->post('usr_eml'); ?>" class="form-control" id="usr_eml" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="usr_snd" value="<?php echo $this->input->post('usr_snd'); ?>" class="form-control" id="usr_snd" />

...
<body>
	...
	<?php if(isset($pgw_dinas['pgwnds_id'])): ?>
	<br>
		<table class="tabel">
			<thead>
				<tr>
	...
	<div style="float: right;text-align: left;display: block;">
		<span><?php echo isse( $permintaan['pgw_jab'])? $permintaan['pgw_jab']:''; ?></span>
		<br><br><br><br>
		<span><?php echo isset($permintaan['pgw_nm'])?$permintaan['pgw_nm']:''; ?></span>
		<br>
		<span><?php echo 'NIP '.isset($permintaan['pgw_nip'])?$permintaan['pgw_nip']:''; ?></span>
	</div>
</body>
</html>
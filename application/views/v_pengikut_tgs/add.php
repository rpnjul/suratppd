    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Pengikut Spd Add</h3>
            </div>
            <?php echo form_open('pengikut_spd/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="sppd_no" class="control-label"><span class="text-danger">*</span>Sppd No</label>
						<div class="form-group">
							<input type="text" name="sppd_no" value="<?php echo $this->input->post('sppd_no'); ?>" class="form-control" id="sppd_no" />
